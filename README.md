...
Either [download](https://s3-eu-west-1.amazonaws.com/maven-repository-jrkoiter/release/nl/fuselogic/robotframework-oimclientlibrary/0.1/robotframework-oimclientlibrary-0.1.jar) the jar file of the current version directly, or build the library from source by following the steps below. A working Maven installation is assumed:
